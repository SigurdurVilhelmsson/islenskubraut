...
// Fixed colors for context/utility question types (independent of category color)
const CONTEXT_COLORS: Record<string, { bg: string; text: string }> = {
  '📍': { bg: '#DC2626', text: '#FFFFFF' }, // Hvar — red
  '🕐': { bg: '#16A34A', text: '#FFFFFF' }, // Hvenær — green
  '👤': { bg: '#EA580C', text: '#FFFFFF' }, // Hver — orange
  '🎯': { bg: '#2563EB', text: '#FFFFFF' }, // Notagildi — blue
};
